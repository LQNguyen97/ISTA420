...
where o.orderdate = 
(select max(orderdate) from Sales.Orders) order by o.empid;
...
select o.custid, o.custid, o.orderid, o.orderdate, o.empid
...
-- who did not handle orders on or after May 1st, 2016
...
select o.orderdate, o.empid from sales.orders o where o.orderdate >= '2016-05-01'
